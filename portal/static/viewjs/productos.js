	...
	transport: {
		read: {
			...
			complete: function (e) {
				...
				ReactDOM.render(React.createElement(ListaProductos, {
					style: stylesFlex,
					reload: true
...
var ProductoSmall = React.createClass({
	...
	is_authenticated: function () {
		...
		if (is_authenticated) return React.createElement('div', null);
	},
	render: function () {
		...
		return React.createElement(
			'div',
			{ className: 'ed-item tablet-30 web-25 main-center art' },
			React.createElement(
				'div',
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'image-responsive producto-img main-center' },
						React.createElement('img', { className: 'image-box', src: this.props.imgurl })
					),
					React.createElement(
						'div',
...
var ListaProductos = React.createClass({
	...
	eachItem: function (producto, i) {
		...
		return React.createElement(ProductoSmall, { key: i,
	...
	render: function () {
		return (
			...
			React.createElement(
				'div',
				{ style: stylesFlex, className: '' },
				React.createElement(
					'div',
					{ className: 'ed-container base-100' },
					this.check(),
